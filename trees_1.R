...
#
# Description:
## This script produces the first and third binary classification trees: 
...
# for Mandarin and for all languages
...
# alternative:
# 1. remove rows where cDist is NA
refs <- refs[!is.na(refs$cDist),]
# 2. replace NA with 1000
